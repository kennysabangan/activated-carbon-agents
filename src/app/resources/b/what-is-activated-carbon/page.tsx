  ...
  return (
    <main className="min-h-screen">
      ...
      <article className="max-w-[800px] mx-auto px-4 py-16">
        ...
        <h1 className="font-headline font-bold text-[36px] mt-4 mb-8">
        ...
        <div className="font-content text-[16px] leading-relaxed space-y-6">
          ...
          <h2 className="font-headline font-bold text-[24px] mt-8 mb-4">How is it Made?</h2>
          <p>
          ...
          <h2 className="font-headline font-bold text-[24px] mt-8 mb-4">Types of Activated Carbon</h2>
          <p>
          ...
          <h2 className="font-headline font-bold text-[24px] mt-8 mb-4">Applications</h2>
          <p>
          ...
          <h2 className="font-headline font-bold text-[24px] mt-8 mb-4">Choosing the Right Activated Carbon</h2>
          <p>
